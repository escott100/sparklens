...
trait AppAnalyzer {
  ...
  def produceMetrics(ac: AppContext): mutable.Map[String, Double] = {
    produceMetrics(ac, ac.appInfo.startTime, ac.appInfo.endTime)
  }
...
object AppAnalyzer {
  def startAnalyzers(appContext: AppContext): Map[String, Double] = {
    ...
    list
      ...
      .foldLeft[Map[String, Double]](Map()) {
